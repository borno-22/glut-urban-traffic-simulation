...
case '1': targetTime = 0.0f; break; // Go to Day
    case '2': targetTime = 1.0f; break; // Go to Sunset
    case '3': targetTime = 2.0f; break; // Go to Night
...
void updateS(int value)
{
    ...
    if (timeOfDay < targetTime) {
        ...
        if (timeOfDay > targetTime) timeOfDay = targetTime;
    }
